...
// 1. Built-in SVG Icons (Zero dependencies needed!)
...
export default function TimesheetForm({ entries, setEntries }) {
  ...
  // Reusable Tailwind classes for clean, consistent UI
            ...
            <div key={entry.id} className={cardClass}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                ...
                <div className="md:col-span-1 flex flex-row md:flex-col justify-between items-center md:items-start md:justify-end pt-4 md:pt-0 mt-2 md:mt-0 border-t border-gray-100 md:border-none">
                  ...
                  <div className="flex h-10 w-full md:w-auto items-center justify-center font-bold text-sm bg-gray-100 text-gray-900 rounded-md px-4 border border-gray-200">
                    {dailyHours || '-'}
                  </div>
                </div>

                {/* Desktop Delete Button (Hovering at top right) */}
                <button 
